...
hero:
  name: "Demo Associazione No-profit"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://associazione-no-profit.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-associazione-no-profit
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Associazione No-profit.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Associazione No-profit** in Italia.
...
Il mercato italiano delle PMI per **Associazione No-profit** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:associazione-no-profit
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-associazione-no-profit)
